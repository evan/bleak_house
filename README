...
Please see the forum ( http://github.com/fauna/bleak_house/issues ) if you have installation problems.
...
The support forum is here[http://github.com/fauna/bleak_house/issues].
